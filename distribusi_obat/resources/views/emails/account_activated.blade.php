...
<body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
    <div style="max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 30px; border-radius: 10px;">
        ...
        <p>Kabar baik! Akun E-Pharma Anda telah <strong style="color: #10b981;">diaktifkan</strong> oleh administrator.</p>
        <p>Gunakan kredensial berikut untuk masuk ke portal E-Pharma:</p>

        <div style="background: #f0fdf4; border-left: 4px solid #10b981; padding: 20px; border-radius: 5px; margin: 20px 0;">
            <table style="width:100%;">
                ...
                <tr>
                    <td>
                        <span style="font-size: 24px; font-weight: bold; letter-spacing: 3px; color: #10b981; font-family: monospace;">
                            {{ $plainPassword }}
                        </span>
                    </td>
                </tr>
