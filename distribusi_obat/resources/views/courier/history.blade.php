    ...
    <div class="d-sm-flex align-items-sm-center justify-content-sm-between mb-3">
        ...
        <div class="flex-fill">
            <h4 class="fw-bold mb-0">
                Arsip Pengiriman Selesai
            </h4>

            <div class="text-muted small">
                Rekam jejak seluruh paket yang telah berhasil Anda antarkan
            </div>
        </div>
        ...
        <div class="mt-3 mt-sm-0 ms-sm-3">
            ...
            <button onclick="fetchHistory()"
                class="btn btn-indigo rounded-pill px-3 shadow-sm fw-bold">
    ...
    <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
        ...
        <div class="card-header bg-transparent border-bottom d-flex align-items-center py-3">
            ...
            <h6 class="mb-0 fw-bold">
                ...
                <i class="ph-clock-counter-clockwise me-2 text-success"></i>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <thead class="table-light">
                    ...
                    <tr class="fs-xs text-uppercase fw-bold text-muted">
                        ...
                        <th class="ps-3" style="width:220px;">
                            No. Resi & Waktu
                        </th>
                    ...
                    <tr>
                        ...
                        <td colspan="5" class="text-center py-5">
                            ...
                            <span class="text-muted small">
                                ...
                                Menyelaraskan arsip pengiriman...
            ...
            historyData.forEach(d => {
                ...
                */
                ...
                const dateStr = deliveredAt
                    ? deliveredAt.toLocaleDateString('id-ID', {
                        day: '2-digit',
                        month: 'short',
                        year: 'numeric'
                    })
                ...
                const timeStr = deliveredAt
                    ? deliveredAt.toLocaleTimeString('id-ID', {
                        hour: '2-digit',
                        minute: '2-digit'
                    })
                    : '-';
    ...
    .catch(err => {
        ...
        tableBody.innerHTML = `
            <tr>
                ...
                <td colspan="5"
                    class="text-center py-5 text-danger small">
            ...
            items.forEach(i => {
                ...
                html += `
                    <div class="list-group-item d-flex justify-content-between align-items-center py-3 px-3">
                        ...
                        <span class="badge bg-indigo rounded-pill px-3">
